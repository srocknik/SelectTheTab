...
class App extends Component {
  state = {activeTabId: projectsList[0].category, isActive: ''}
  ...
  render() {
    ...
    const filterProjectList = this.getFilteredProjectList()
        ...
        <ul className="tabs-container">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              updateTabItem={this.updateTheTabItem}
